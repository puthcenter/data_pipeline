...
## 📖 Project Overview
This repository contains the implementation and benchmarking suite for the **Profit Maximization in Data Pipelines with Externalities (PiPE)**.
...
* **[`code/`](./code)**: Contains the source code for all algorithms and the benchmarking runner.
    * *Implementations of Greedy, SA, SASA, QPBO, SCIP, SGHC, etc.*
...
| **SCIP** | Exact | Integer Linear Programming solver (using SCIP) for ground truth verification. |
